# Kolos Auto Detailing — Launch Setup

## 1. Google Calendar availability
The **Open Live Availability** button in `index.html` links directly to the public Google Calendar appointment schedule:

`https://calendar.app.google/9u6gRaozdZaFAMJs7`

If the appointment schedule changes, update that link in `index.html`.

## 2. Booking and vehicle photos
